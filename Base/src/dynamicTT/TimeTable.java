...
//		this.professors=professors;
    ...
    public TimeTable(TimeTable tt) {
        this.aulas = tt.getAulas();
        this.fittness = tt.getFittness();
        this.clases = tt.clases;
        this.gruposAlumnos = tt.gruposAlumnos;
        this.gruposAlumnosPracticos = tt.getGruposAlumnosPracticos();
        this.gruposAlumnosTeoricos = tt.getGruposAlumnosTeoricos();
        this.aulasPracticas = tt.getAulasPracticas();
        this.aulasTeoricas = tt.getAulasTeoricas();
        this.personalTimeTable = tt.personalTimeTable;
    }
